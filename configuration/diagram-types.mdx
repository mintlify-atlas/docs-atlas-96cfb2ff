---
title: Diagram Types
description: All 7 Mermaid diagram types supported by Omni Architect
---

Omni Architect supports 7 different Mermaid diagram types, each serving a specific purpose in visualizing product logic. Configure which diagrams to generate using the `diagram_types` parameter.
...
skills run omni-architect \
  --diagram_types '["flowchart","sequence","erDiagram","stateDiagram","C4Context","journey","gantt"]' \
  # ... other parameters
```
...
### 5. C4 Context Diagram (`C4Context`)
